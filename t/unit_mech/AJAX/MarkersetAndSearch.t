...
$mech->get_ok('http://localhost:3010/list/item/add?list_id='.$markerset_list_id.'&element={"marker_name":"S1_21594", "allele_dosage":"0.897"}');
$response = decode_json $mech->content;
is($response->[0],'SUCCESS');
...
is($number_of_accessions_dosage,1);
